...
const { Step } = Steps;
interface WorkflowSegmentModalProps {
  visible: boolean;
  toggle: (status: boolean) => any;
}
const WorkflowSegmentModal: FC<WorkflowSegmentModalProps> = ({
  visible,
  toggle,
}) => {
...
export default WorkflowSegmentModal;
